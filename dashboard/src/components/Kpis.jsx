    ...
    return (
        <ul className="row list-unstyled g-3">
            <li className="col-md-3">
                <div className="card text-white rounded p-3 h-100" style={{ backgroundColor: '#0A0A0A', border: "1px solid #191919" }}>
            ...
            <li className="col-md-3">
                <div className="card text-white p-3 h-100 rounded" style={{ backgroundColor: '#0A0A0A', border: "1px solid #191919" }}>
                    <div className="d-flex justify-content-between align-items-start">
